...
import { R2Cache, R2Leases, S3Cache, S3Leases } from '@/index';
...
describeContainerIntegration('s3 and r2 adapter integration', () => {
  ...
  it(
    'stores values and respects TTL with s3 cache',
    async () => {
  ...
  it(
    'acquires, marks ready, and releases s3 leases',
    async () => {
  ...
  it(
    'stores values and respects TTL with r2 cache',
    async () => {
  ...
  it(
    'acquires, marks ready, and releases r2 leases',
    async () => {
